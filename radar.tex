...
A análise apresentada neste artigo focou na comparação entre a ACP e o \wnominate. Mas devido à existências de muitos métodos possíveis para a construção de mapas de votações espaciais, muitas outras comparações podem ainda ser feitas. Alguns dos alvos de comparação seriam as variações do \nominate (DW-NOMINATE~\cite{poole2001dnomiante}, Alpha-Nominate\cite{carroll2013alpha}, etc.), o IDEAL~\cite{clinton2004ideal}, o modelo  IRT (Item Response Theory)~\cite{linden2013irt}, e até mesmo variações da ACP especializadas em dados categóricos~\cite{landgraf2015logisticpca}.
