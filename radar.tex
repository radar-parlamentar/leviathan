...
Apesar da influência do \emph{survey} nos resultados, em uma análise visual subjetiva, ao comparar o mapa de votações produzido por Zuco e Lauderdale~\cite{zucco2011distinguishing} com os nossos mapas, é perceptível uma coerência entre padrões de aglomeração de partidos produzidos por ambas as abordagens.
