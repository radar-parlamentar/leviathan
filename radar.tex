...
\hline
cdep2007-2010 & 1,26 $\pm$ 0,02 & 75,21 \\ 
cdep2011-2014 & 0,67 $\pm$ 0,03 & 58,06 \\ 
sen2007-2010  & 0,03 $\pm$ 0,01 & 2,52  \\ 
sen2011-2014  & 0,03 $\pm$ 0,00 & 3,17  \\ 
cmsp2013-2016 & 0,02 $\pm$ 0,00 & 9,66  \\ 
\end{tabular} 
\caption{Tempos de execução, apresentando médias e desvios padrão em segundos, calculados com base em 10 execuções.}
\label{tab:tempos}
\end{table}

\todo{média e desvio padrão do \wnominate}
...
\todo{porcentagem da variação explicada pelas dimensões da ACP}
...
\Leo{Falar que usamos o pacote wnominate do Poole.}

\Leo{Falar que wnominate joga fora os votos nulos, e o PCA não.}

\Leo{No mesmo computador, sempre os mesmos resultados (exceto tempo). Mas em máquinas diferentes, o resultado pode variar}
...
\todo{Análise temporal... utilizar mapas do senado pra demonstrar intuitivamente o algoritmo de rotação.}

\todo{Análise dimensionalidade}
