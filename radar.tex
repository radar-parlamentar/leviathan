...
Ainda na Figura~\ref{fig:projecao_cp1}, o segmento de reta vermelho destaca o trecho de CP1 sobre o qual incidem as projeções dos pontos. O tamanho desse segmento está relacionado com a variância dos dados sobre a dimensão definida por CP1, sendo que a reta CP1 foi escolhida pela ACP justamente por fornecer a maior variância possível dos dados em uma dimensão. Se escolhermos qualquer outra reta pra definir uma nova dimensão, como $r2$ na Figura~\ref{fig:projecao_r2}, teremos uma variância menor do que a variância dos dados sobre CP1.
