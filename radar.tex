...
Os algoritmos de Poole estabelecem um corte para descartar da análise votações unânimes ou quase unânimes. Esse corte parte da ideia de que votações quase unânimes não revelam diferenças entre os parlamentares, e por isso não agregam à análise.

Por outro lado, caso não se descarte nenhuma votação, quanto mais votações unânimes ou quase unânimes existirem, mais os parlamentares estarão concentrados no mapa. Isso pode não ajudar a revelar as diferenças entre os parlamentares, mas pode ajudar a revelar que talvez eles não sejam tão diferentes assim, o que consideramos uma análise útil. Por isso, em nossa abordagem não há descarte de votações unânimes ou quase unânimes.
