...
\makepagestyle{leviathan}
  ...
  \makeevenhead{leviathan} %%pagina par
     {\diam{\textcolor{white}{\small \texttt{\textbf{Leviathan |}} {\footnotesize Cadernos de Pesquisa Política}}} {\diaminvisible{\scriptsize N. 12, pp.120--163, 2016}}} % esquerda
     {} % centro
     {} % direita
