...
\ins{Explicar critério de seleção de casas/períodos analisados.}

\ins{Justificar comparação com wnominate}

\ins{minvotes=20 lop=0.025}

\ins{Mostrar gráficos dos resultados}
...
\Leo{Problema: muitos partidos, poucas cores... comentar sobre isso. Talvez tentar variar a forma também}.
...
\ins{Mostrar tabela com indicadores dos resultados PCA vs wnominate\\}

\Leo{Objetivo não é quem é melhor, mas mostrar resultados da ACP e ter indicadores do wnominate como referência}
