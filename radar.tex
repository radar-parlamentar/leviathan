...
\todo{Citar Leoni (wnominate na cdep: parei em ``Dimensionalidade e Precisão do Modelo no Caso Brasileiro'')... e ribeiro (wnomiante no chile)}
...
Utilizando o W-NOMINATE, uma variação do \nominate, Leoni~\cite{leoni02cdep} chegou à conclusão de que uma dimensão explica a maior parte das votações na Câmara dos Deputados, pois dimensões adicionais não melhoram significativamente a capacidade explicativa do modelo estatístico.
