...
\newcommand{\diam}[1]{\tikz\draw (0,0)node[fill=darkred,shape aspect=1,draw,inner sep=2pt]{#1};}
\makepagestyle{leviathan}
  %%cabeçalhos
  \makeevenhead{leviathan} %%pagina par
     {\diam{\textcolor{white}{\textbf{Leviathan} | Cadernos de Pesquisa Política}}} % esquerda
     {} % centro
