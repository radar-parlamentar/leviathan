...
% epsaçamento entre o texto e o header
\setlength{\headsep}{1.2cm} 

% espalamento entre linhas
\linespread{1.5}
...
\newcommand{\diam}[1]{\tikz\draw (0,0)node[draw=darkred,fill=darkred,shape aspect=1,draw,inner ysep=5.25pt,inner xsep=9pt]{#1};}
...
\makepagestyle{leviathan}
  ...
  \makeevenhead{leviathan} %%pagina par
     {\diam{\textcolor{white}{\small \texttt{\textbf{Leviathan |}} {\footnotesize Cadernos de Pesquisa Política}}} {\diaminvisible{\scriptsize N. 12, pp.1--44, 2016}}} % esquerda
     {} % centro
     {} % direita
  \makeoddhead{leviathan} %%pagina ímpar ou com oneside
     {\diam{\textcolor{white}{\small \texttt{\textbf{Leviathan |}} {\footnotesize Cadernos de Pesquisa Política}}}} % esquerda
     {} % centro
