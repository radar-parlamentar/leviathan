...
\todo{E Izumi, oq eu diz sobre isso?}
...
Nesta seção apresentaremos os resultados que a ACP fornece quando aplicados a casas legislativas brasileiras. Os dados utilizados são os dados abertos provenientes das respectivas casas legislativas. Realizamos análises sobre votações das casas de nosso conhecimento que disponibilizam abertamente os dados de votações nominais. São essas casas: Câmara dos Deputados, Senado e Câmara Municipal de São Paulo.

Seguindo o mesmo procedimento adotado por Izumi~\cite{izumi2016senado} e Leoni~\cite{leoni02cdep}, adotamos a legislatura completa como unidade de análise. Para privilegiar o uso de legislaturas completas, para a Câmara dos Deputados e para o Senado, escolhemos as legislaturas 2007-2010 e 2011-2014. Assim iremos mostrar o uso da ACP em diferentes casas e em diferentes momentos do tempo. Para a Câmara Municipal de São Paulo, devido a restrição de dados fornecidos, escolhemos a legislatura 2013-2016. Apesar de não se tratar de uma legislatura completa, isso é amenizado pelos fatos de que já nos encontramos no fim da legislatura e de que estamos utilizando dados atualizados.

A relação de partidos presentes nos mapas espaciais produzidos é exibido na Figura~\ref{fig:partidos}. Para a distinção entre os partidos, temos aqui o problema da grande quantidade de partidos no Brasil. As cores escolhidas são relativamente arbitrárias. Para os principais partidos procurou-se utilizar as cores que representam os partidos, mas isso não foi aplicado a todos os partidos. \Leo{Tentar usar formas geométricas também?}
...
Os mapas espaciais de votações produzidos com a ACP são exibidos nas Figuras~\ref{fig:cdep2007-2010}, \ref{fig:cdep2011-2014}, \ref{fig:sen2007-2010}, \ref{fig:sen2011-2014} e \ref{fig:cmsp2013-2016}.
...
\hline 
cdep2007-2010 & 92 & 93 & 91 & 92 & 46 & 50 & 55 & 62 \\ 
cdep2011-2014 & 87 & 89 & 87 & 89 & 28 & 40 & 42 & 52 \\ 
sen2007-2010  & 91 & 92 & 92 & 93 & 60 & 65 & 67 & 74 \\ 
sen2011-2014  & 87 & 88 & 87 & 90 & 34 & 42 & 46 & 56 \\ 
cmsp2013-2016 & 93 & 94 & 96 & 97 & 61 & 69 & 77 & 83 \\ 
\end{tabular} 
...
\hline
cdep2007-2010 & 1,17 & 75,21 \\ 
cdep2011-2014 & 0,54 & 58,06 \\ 
sen2007-2010  & 0,01 & 2,52  \\ 
sen2011-2014  & 0,02 & 3,17  \\ 
cmsp2013-2016 & 0,03 & 9,66  \\ 
\end{tabular} 
\caption{Tempos de execução em segundos.}
\label{tab:tempos}
\end{table}
...
Uma importante diferenciação realizada pelas execuções da ACP e do \wnominate, é que no \wnominate escolhemos a opção padrão da biblioteca em utilizar os parâmetros \textsf{minvotes=20} e \textsf{lop=0.025}. Isso significa que o algoritmo descarta parlamentares ausentes em pelo menos 20 votações e descarta as votações nas quais menos de 2,5\% dos deputados votou com a minoria. Já na execução da ACP descartamos apenas as votações unânimes. Uma justificativa parcial para essas decisões, é de que utilizar \textsf{minvotes=0} e \textsf{lop=0.0} para o \wnominate deixa o algoritmo muito demorado. \Leo{quanto?}. Por outro lado, utilizar \textsf{minvotes=20} e \textsf{lop=0.025} para a ACP resultou em mapas espaciais de difícil leitura quanto ao significado político. Para se ter uma ideia, nem a polarização PT vs PSDB era possível enxergar. \Leo{Mostrar um desses gráficos?}


\Leo{Indicar qual das casas explicita voto ausente. Acho q é só cdep. Se for o caso, deveríamos descartar esses votos pra análise ficar mais similar a de outras casas?}

As análises apresentadas nesta seção foram feitas no software de estatística \textbf{R}, e o código que produziu esses resultados está disponível em \url{https://github.com/radar-parlamentar/pesquisa/tree/master/R}. Esses scripts foram executados em um laptop Dell Vostro 5480, com 8GB de memória RAM e com a 5ª geração do Processador Intel® CoreTM i7-5500U. O sistema operacional utilizado é o ArchLinux com kernel Linux  versão ``4.7.2-1-ARCH \#1 SMP PREEMPT Sat Aug 20 23:02:56 CEST 2016'' para arquitetura x86\_64.
